...
2. Run `antlr4 -o ./src/sparkql SqlBaseLexer.g4 SqlBaseParser.g4`
...
## TODO
```
$javac -cp src:/usr/local/lib/antlr-4.13.2-complete.jar src/sparkql/*.java src/TestSQLParse.java
$java -cp src:/usr/local/lib/antlr-4.13.2-complete.jar TestSQLParse
```
